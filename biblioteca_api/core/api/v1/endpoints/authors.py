...
from schemas.author_schema import Author, AuthorCreate
from crud.author_crud import author_crud
...
def create_new_author(author: AuthorCreate, db: Session = Depends(get_db)):
    # Opcional: Verifique se um autor com o mesmo nome já existe
...
def delete_existing_author(author_id: int, db: Session = Depends(get_db)):
    ...
    return # Retorna 204 No Content para DELETE bem-sucedido